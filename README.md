...
**Note**: Generated protobuf files (`gen/go/`, `webui/gen/ts/`) are not tracked in git. They are generated locally and required for builds. If you modify `.proto` files, run `make generate-proto`.
